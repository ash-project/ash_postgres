    ...
    quote bind_quoted: [opts: opts], location: :keep do
      ...
      def side_load(records, side_load_keyword, resource) do
        if @repo.in_transaction?() do
          raise "Can't side load in a transaction bruh"
        end

        full_keyword =
          AshEcto.DataLayer.add_through_schema_fields(@repo, resource, side_load_keyword)

        {:ok, @repo.preload(records, full_keyword)}
      end
